...
FAQS = [
    ...
    {"question": "Wie funktioniert der PC Builder?", "category": "konfigurator",
     "answer": "Du wählst Schritt für Schritt deine Komponenten. Der PC Builder prüft – soweit die Daten es erlauben – die Kompatibilität und erstellt eine übersichtliche Zusammenfassung als Anfrage."},
