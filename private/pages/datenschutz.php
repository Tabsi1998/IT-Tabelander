...
$pageMeta = page_meta('datenschutz');
$pageSchema = [];
?>
<!DOCTYPE html>
    ...
    <main class="legal-shell">
        ...
        <section class="legal-page">
            ...
            <article class="legal-panel">
                ...
                <p>Zur einheitlichen Bearbeitung können Name, Kontaktdaten, gewählter Leistungsbereich und Nachricht in das von IT-Tabelander betriebene ERP-System Dolibarr übernommen werden. Dabei wird der Kontakt zunächst als Interessent und die allgemeine Anfrage als internes Ticket angelegt.</p>
                <p>Bei einer über den Controller-Konfigurator vorbereiteten Upgrade-Anfrage werden stattdessen die Controller-Auswahl und die Kontaktdaten in einen internen Angebotsentwurf übernommen. Die Website validiert und versendet daraus nicht automatisch ein verbindliches Angebot; die technische und kaufmännische Prüfung erfolgt zuerst persönlich.</p>
                <p>Die Website versendet aus diesen Formularen keine automatische E-Mail. Das technische Anwendungslog enthält nur Zeitstempel, eine zufällige Request-ID, Dolibarr-IDs und den Übergabestatus. Name, Kontaktdaten, Nachrichteninhalt und IP-Adresse werden dort nicht gespeichert. Die Logeinträge werden standardmäßig nach 30 Tagen automatisch entfernt; der Betreiber kann die Frist verkürzen oder das persistente Logging vollständig deaktivieren.</p>
                <p>Empfänger der Daten sind interne Ansprechpartner sowie die eingesetzten Hosting- und ERP-Dienstleister. Die Daten werden so lange gespeichert, wie dies zur Bearbeitung der Anfrage und zur Erfüllung gesetzlicher Pflichten erforderlich ist.</p>
            </article>
