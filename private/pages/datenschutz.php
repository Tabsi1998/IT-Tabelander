    ...
    <main class="legal-shell">
        ...
        <section class="legal-page">
            ...
            <article class="legal-panel">
                ...
                <p>Bei einer über den Controller-Konfigurator vorbereiteten Anfrage können Name, Kontaktdaten, Controller-Auswahl und Nachricht zusätzlich in das von IT-Tabelander betriebene ERP-System Dolibarr übernommen werden. Dort wird zunächst ausschließlich ein interner Angebotsentwurf zur Prüfung und weiteren Bearbeitung angelegt; die Website versendet daraus nicht automatisch ein verbindliches Angebot.</p>
