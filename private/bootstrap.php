...
{
    return '<aside class="cookie-notice" data-cookie-notice hidden role="dialog" aria-modal="true" aria-labelledby="cookie-notice-title">'
        . '<div class="cookie-notice-panel" data-cookie-panel>'
        . '<div class="cookie-notice-copy">'
        . '<p class="cookie-notice-kicker">Cookie-Einstellungen</p>'
        . '<h2 class="cookie-notice-title" id="cookie-notice-title">Datenschutz-Einstellungen</h2>'
        . '<p>Wir verwenden essenzielle Funktionen für Sicherheit und Formularschutz. Google Analytics wird nur aktiviert, wenn Sie zustimmen. Ihre Auswahl gilt 30 Tage und kann in der Datenschutzerklärung geändert werden.</p>'
        . '</div>'
        . '<div class="cookie-choice-list" aria-label="Cookie-Kategorien">'
        . '<label class="cookie-choice is-required">'
        . '<span class="cookie-choice-main"><strong>Essenziell</strong><span>Erforderlich für Formularschutz, Sicherheit, Sitzungen und Grundeinstellungen der Website.</span></span>'
        . '<input type="checkbox" checked disabled aria-label="Essenzielle Cookies immer aktiv">'
        . '</label>'
        . '<label class="cookie-choice">'
        . '<span class="cookie-choice-main"><strong>Analytics</strong><span>Hilft zu verstehen, welche Seiten genutzt werden. Google Analytics wird erst nach Zustimmung geladen.</span></span>'
        . '<input type="checkbox" data-cookie-analytics aria-label="Google Analytics erlauben">'
        . '</label>'
        . '</div>'
        . '<div class="cookie-notice-actions">'
        . '<a href="' . e(page_url('datenschutz.php')) . '">Datenschutz</a>'
        . '<button class="button button-secondary button-compact" type="button" data-cookie-reject>Nur essenziell</button>'
        . '<button class="button button-secondary button-compact" type="button" data-cookie-save>Auswahl speichern</button>'
        . '<button class="button button-primary button-compact" type="button" data-cookie-accept>Alle akzeptieren</button>'
        . '</div>'
        . '</div>'
        . '</aside>';
}
