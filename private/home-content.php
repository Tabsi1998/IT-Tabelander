...
return [
    ...
    'serviceBands' => [
        ...
        [
            'title' => 'PS5-Controller-Upgrades',
            'image' => 'controller-konsolen-service',
            'imageAlt' => 'PS5-Controller für einen individuellen Upgrade-Umbau',
            'imageWidth' => 1536,
            'imageHeight' => 1024,
            'intro' => 'Hall-Effect-Sticks, Clicky-Tasten, Back-Paddles, ein größerer Akku oder LED-Beleuchtung: Im Konfigurator stellen Sie passende DualSense-Upgrades mit transparenten Pauschalpreisen zusammen.',
            'items' => ['Upgrades für DualSense und DualSense Edge', 'Pauschalpreise direkt zusammenstellen', 'Reparaturen separat und individuell anfragen'],
            'audience' => 'DualSense · DualSense Edge · Upgrades',
            'groups' => ['gaming'],
            'url' => 'controller-service-telfs',
            'cta' => 'Controller-Upgrade konfigurieren',
        ],
    ],
    'faq' => [
        [
